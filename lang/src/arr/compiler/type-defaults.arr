...
t-reactor = t-name(module-uri("builtin://reactors"), A.s-type-global(A.dummy-loc, "Reactor"))
t-equality-result = t-name(module-uri("builtin://equality"), A.s-type-global(A.dummy-loc, "EqualityResult"))
t-value-skeleton = t-name(module-uri("builtin://valueskeleton"), A.s-type-global(A.dummy-loc, "ValueSkeleton"))
t-list = t-name(module-uri("builtin://lists"), A.s-type-global(A.dummy-loc, "List"))
t-big-array = t-name(module-uri("builtin://arrays"), A.s-type-global(A.dummy-loc, "Array"))
t-set = t-name(module-uri("builtin://sets"), A.s-type-global(A.dummy-loc, "Set"))
t-avl = t-name(module-uri("builtin://sets"), A.s-type-global(A.dummy-loc, "AVLTree"))
t-runtime-error = t-name(module-uri("builtin://error"), A.s-type-global(A.dummy-loc, "RuntimeError"))
t-parse-error = t-name(module-uri("builtin://error"), A.s-type-global(A.dummy-loc, "ParseError"))
t-either = t-name(module-uri("builtin://either"), A.s-type-global(A.dummy-loc, "Either"))
t-s-exp = t-name(module-uri("builtin://s-exp-structs"), A.s-type-global(A.dummy-loc, "S-Exp"))
t-pick = t-name(module-uri("builtin://pick"), A.s-type-global(A.dummy-loc, "Pick"))
t-json = t-name(module-uri("builtin://json-structs"), A.s-type-global(A.dummy-loc, "JSON"))
t-string-dict = t-name(module-uri("builtin://string-dict"), A.s-type-global(A.dummy-loc, "StringDict"))
...
module-const-pick = t-module("builtin://pick",
  ...
  SD.make-string-dict()
    .set("Pick", t-name(module-uri("builtin://pick"), A.s-type-global(A.dummy-loc, "Pick")))
)
