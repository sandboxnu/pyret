...
◊docmodule["math"]{
  ...
  ◊examples{
    ...
    check:
      M.max([L.list: ]) raises "The list is empty"
  ...
  ◊examples{
    ...
    check:
      M.min([L.list: ]) raises "The list is empty"
      M.min([L.list: 2]) is 2
  ...
  ◊examples{
    ...
    check:
      M.arg-max([L.list: ]) raises "The list is empty"
  ...
  ◊examples{
    ...
    check:
      M.arg-max([L.list: ]) raises "The list is empty"
      M.arg-max([L.list: 8]) is 0
      M.arg-max([L.list: -1, 0, ~1, -3, 5]) is 4
    end
  }
  }
}
